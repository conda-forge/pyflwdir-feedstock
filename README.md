...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyflwdir-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11069&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyflwdir-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyflwdir` can be installed with:

```
conda install pyflwdir
```

It is possible to list all of the versions of `pyflwdir` available on your platform with:
